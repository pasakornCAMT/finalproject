...
public class DataLoader implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Product product01=Product.builder().productId("P-001").name("Singha").description("Singha drinking water").price(100).image(imageBaseUrl+"product1.jpg").show(true).build();
        Product product02=Product.builder().productId("P-002").name("Nestle").description("Nestle pure life").price(200).image(imageBaseUrl+"product2.jpg").show(true).build();
        Product product03=Product.builder().productId("P-003").name("Crystal").description("Crystal very good water").price(300).image(imageBaseUrl+"product3.jpg").show(true).build();
